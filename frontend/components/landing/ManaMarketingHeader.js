...
const circleBtn =
  'flex h-10 w-10 shrink-0 box-border items-center justify-center rounded-full border border-solid border-[rgba(255,255,255,0.1)] bg-[#050505] backdrop-blur-[5px] transition-opacity hover:opacity-90';
